# Taken from original recipe in OpenEmbedded with minor modifications to
# enable compressed offload.
...
add_custom_config_files() {
    install -d ${D}${datadir}/pipewire/pipewire.conf.d
    install -m 0644 ${WORKDIR}/load-compressed-sink.conf ${D}${datadir}/pipewire/pipewire.conf.d
}

do_install[postfuncs] += "remove_unused_installed_files"
do_install[postfuncs] += "add_custom_config_files"
